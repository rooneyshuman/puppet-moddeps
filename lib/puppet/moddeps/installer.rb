...
module Puppet
  module Moddeps
    class Installer
      ...
      attr_reader :module_path, :puppet_version
      ...
      #
      # @param puppet_module [String]
      #   The name of a locally installed puppet module. This paramter may be
      #   repeated an unlimited number of times to account for multiple local
      #   modules.
      #
